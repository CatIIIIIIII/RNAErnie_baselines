...
from RNAMSM.utils.metrics import rna_compute_precisions
from RNAMSM.utils.tensor import symmetrize, apc

from RNAMSM.modules import (
...
from RNAMSM.product_key_memory import PKM

import RNAMSM.lr_schedulers as lr_schedulers
from RNAMSM.dataset import RNADataset
    ...
    def configure_optimizers(self):
        ...
        if self.optimizer_config.name == "adam":
            ...
            try:
                ...
                raise ImportError(
                    "Apex must be installed to use FusedLAMB optimizer.")
...
class MSATransformer(BaseProteinModel):
    def __init__(
        ...
        if embed_positions_msa:
            ...
            self.register_parameter(
                "msa_position_embedding", None)  # type: ignore
    ...
    def forward(
        ...
        padding_mask = tokens.eq(1)  # B, R, C
